...
export function App() {
  ...
  return (
      ...
      <nav className="bg-transparent flex justify-center gap-1 py-3 flex-shrink-0">
        <motion.button 
          className={`px-18 py-9 rounded-3xl text-xl font-black transition-all duration-500 ${tab==='home'?'bg-mint text-white shadow-2xl':'bg-mint-soft text-ink hover:bg-mint/40'}`}
        ...
        <motion.button 
          className={`px-18 py-9 rounded-3xl text-xl font-black transition-all duration-500 ${tab==='history'?'bg-mint text-white shadow-2xl':'bg-mint-soft text-ink hover:bg-mint/40'}`}
          initial={{ scale: 0.5, opacity: 0, y: 50, rotateX: -90 }}
          animate={{ scale: 1, opacity: 1, y: 0, rotateX: 0 }}
          transition={{ 
            delay: 0.2, 
        ...
        <motion.button 
          className={`px-18 py-9 rounded-3xl text-xl font-black transition-all duration-500 ${tab==='stats'?'bg-mint text-white shadow-2xl':'bg-mint-soft text-ink hover:bg-mint/40'}`}
          initial={{ scale: 0.5, opacity: 0, y: 50, rotateX: -90 }}
          animate={{ scale: 1, opacity: 1, y: 0, rotateX: 0 }}
          transition={{ 
            delay: 0.3, 
